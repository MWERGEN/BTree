...
\usepackage[ruled,vlined,linesnumbered,noresetcount]{algorithm2e} % Algorithmen
\SetAlgorithmName{Algorithmus}{algorithmus}{Liste der Algorithmen}
\SetKwInput{KwData}{Eingabe}
\SetKwInput{KwResult}{Ausgabe}
\usepackage{lipsum}    
